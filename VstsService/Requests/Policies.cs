...
namespace SecurePipelineScan.VstsService.Requests
{
    public static class Policies
    {
        ...
        public static IVstsRestRequest<Response.Multiple<Response.Policy>> All(string project)
        {
            return new VstsRestRequest<Response.Multiple<Response.Policy>>($"{project}/_apis/policy/configurations");
        }
    }
}