...
{
    public class NobodyCanDeleteTheReleasedPipeline : NobodyCanDeleteThisBase, IRule, IReconcile
    {
        ...
        public NobodyCanDeleteTheReleasedPipeline(IVstsRestClient client)
        {
            _client = client;
            _namespaceId = _client
                .Get(VstsService.Requests.SecurityNamespace.SecurityNamespaces())
                .SelectMany(x => x.Actions)
                .First(s => s.Name == "DeleteReleaseDefinition").NamespaceId.ToString();
        }
